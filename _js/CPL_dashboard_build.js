...
// 🟢 Jekyll change: Output directly as a layout file or explicit HTML file in your project
const OUT = process.env.CPL_OUT || path.join(__dirname, "cpl", "index.html");
const TEMPLATE = process.env.CPL_TEMPLATE || path.join(__dirname, "template.html");

const TEMPLATE_B64 = "PCFET0NUWVB...[Keep your original massive base64 string here]...";
...
async function main() {
  ...
  // 🟢 Change: Instead of grabbing from the browser 'window', load the JSON files generated by fetch-data.js
  ...
  for (const mu of completed) {
    ...
    // 🟢 Change: Look inside your local json object instead of the window variable
  ...
  // Replace the TEMPLATE_B64 section with a simple file read:
  const templatePath = path.join(__dirname, "template.html");
  if (!fs.existsSync(templatePath)) {
    throw new Error("template.html is missing from the repository root!");
  }
